function [A,B,filler] = ffdiag_ortho(T, eps, max_iter)
    ...
    %
    % eps : double, optional
    %     Convergence criterion for matrix updates (default: 1.0e-08).
    %
    ...
    while iter_eps > eps && n_iter < max_iter
        n_iter = n_iter + 1;
        Vn1 = V;
